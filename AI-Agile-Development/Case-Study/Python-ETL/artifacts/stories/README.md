...
The eight stories Amara sliced out of the PRD using [P07 — Slice the PRD into Stories](../../../../AI-Prompts-Library/phase-1-discovery/P07-slice-the-prd-into-stories.md).
...
|---|---|---|---|---|
| [NWD-101](NWD-101.md) | Land counterparty PDFs immutably in the raw zone | 2 | Tomas | 2 |
| [NWD-102](NWD-102.md) | Classify an incoming PDF to its counterparty layout | 5 | Tomas | 2 |
| [NWD-103](NWD-103.md) | **Gate every extracted field on its confidence score** | 8 | Tomas | 2 |
| [NWD-104](NWD-104.md) | Translate EM documents to English before matching | 5 | Tomas | 3 |
| [NWD-105](NWD-105.md) | Redact PII before anything is persisted | 3 | Tomas | 3 |
| [NWD-106](NWD-106.md) | Transform extracted fields into the canonical position schema | 3 | Tomas | 2 |
| [NWD-107](NWD-107.md) | Load positions into Azure SQL and Snowflake idempotently | 5 | Tomas | 2 |
| [NWD-108](NWD-108.md) | Exception queue screen for analyst review | 8 | Ji-woo | 2 |
...
Amara refused, and the reason is worth understanding.
...
- **NWD-101** — a PDF arrives and is provably retained, immutably, at a known path. Priya could watch it happen.
- **NWD-103** — a document with a low-confidence figure does not reach the warehouse. That is a *behaviour*, and Ananya can write a test for it that fails today.
- **NWD-108** — Priya opens a screen and fixes a value. She can tell you in five seconds whether it works.

### The one that was nearly missed

[NWD-108](NWD-108.md) did not exist in the first pass.

The design at that point rejected low-confidence documents and logged the rejection, which satisfied every line of the PRD except one. Amara's question — *"rejected to where? Priya still has to do something with it"* — is what created this story.
...
Sofia owns that template change. See the [retrospective](../retrospective-sprint-3.md).
